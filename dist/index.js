...
const resolvers = {
    ...
    Mutation: {
        requestKaraoke: (_, { name, artists, duration, id }) => {
    ...
    Subscription: {
        ...
        addedKaraoke: {
            subscribe: withFilter(() => pubsub.asyncIterator("KARAOKE_ADDED"), (payload, variables) => {
                return (payload.addedKaraoke.id === variables.id);
            })
        }
    }
};
